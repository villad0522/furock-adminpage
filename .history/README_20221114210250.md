# FUROCK管理ページ
このプログラムは、[FUROCKのホームページ](https://fu-rock.com/)を編集できる[管理ページ](https://rentalserver-staffpage.s3.ap-northeast-1.amazonaws.com/index.html)を動かすためのものです。言語はJavaScriptで記述しています。
