# FUROCK管理画面
このリポジトリには、福岡大学宇宙探査サークル「FUROCK」の[ホームページ](https://fu-rock.com/)の[管理画面](https://rentalserver-staffpage.s3.ap-northeast-1.amazonaws.com/index.html)のソースコードが入っています。言語はJavaScriptで記述しています。
