# FUROCK管理ページ
このプログラムは、[FUROCKのホームページ](https://fu-rock.com/)を編集するための[管理ページ](https://rentalserver-staffpage.s3.ap-northeast-1.amazonaws.com/index.html)のソースコードです。言語はJavaScriptで記述しています。
